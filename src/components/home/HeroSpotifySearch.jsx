...
export default function HeroSpotifySearch({ setPage, isLoggedIn }) {
  ...
  return (
    <div style={{ width: '100%', maxWidth: 620, margin: '0 auto', position: 'relative' }}>
      ...
      <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap', marginTop: 22, width: '100%' }}>
        {heroPreview ? (
        ...
        <button type="button" className="bs" onClick={() => setPage('subscriptions')} style={{ flex: 1, padding: '14px 22px', fontSize: 15.5, minWidth: 110 }}>
          Pricing
        </button>
      </div>
    </div>
